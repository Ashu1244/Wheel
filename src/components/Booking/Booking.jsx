...
const Booking = ({tour,avgRating}) => {
    ...
    const [credentials,setCredentials]=useState({
        userId:'01',//it will be dyanamic later
  ...
  return (
    <div className='booking'>
        ...
        justify-content-between'>
            ...
            <span className='tour__rating d-flex align-itms-center '>
...
<div className="booking__bottom">
    ...
    <Button className='btn primary__btn w-100 mt-4'style={{ color:"black",textDecoration: 'none' }} onClick={handleClick}>Book Now</Button>
</div>
